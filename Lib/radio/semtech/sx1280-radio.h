...
typedef struct
{
     ...
     * \param [IN] crc_error  True if a header or payload crc_error occurred, false for correct packet reception
     */
    void    ( *RxDone )( uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr, bool crc_error );
    /*!
    ...
    /*!
     * \brief Sync (header / sync word valid) detected callback prototype.
     */
    void ( *RxSync ) ( void ) ;
...
struct Radio_s
{
    ...
    *        the radio interrupts by the mask
    ...
    /*
     * The next functions are available only on SX1280 radios.
     */
    /*!
     * \brief Sets the radio in reception mode with Max LNA gain for the given time
     *
     * \remark Available on SX1280 radios only.
     *
...
#include "radio/semtech/sx1280.h"
#include "radio/semtech/sx1280-board.h"
