...
#define REG_LR_WHITSEEDBASEADDR_MSB                REG_LR_WHITSEEDBASEADDR
#define REG_LR_WHITSEEDBASEADDR_LSB                (REG_LR_WHITSEEDBASEADDR + 1)

/*!
 * \brief The address of the register holding the packet configuration
 */
#define REG_LR_PACKETPARAMS                         0x09C1
 ...
 */
#define REG_LR_SYNCWORDBASEADDRESS                  0x09CE
 ...
 */
#define REG_RX_GAIN                                 0x0891
#define REG_LR_ESTIMATED_FREQUENCY_ERROR_MSB        0x0954
#define REG_LR_ESTIMATED_FREQUENCY_ERROR_MID        0x0955
#define REG_LR_ESTIMATED_FREQUENCY_ERROR_LSB        0x0956
...
typedef enum RadioCommands_e
{
    ...
    RADIO_SET_PERF_COUNTER_MODE             = 0x9C,
 ...
 *
 * \remark A valid packet type must have been configured with \ref SX1280SetPacketType
